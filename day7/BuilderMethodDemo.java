...
public class BuilderMethodDemo {
        public static void main(String[] args) {
			Pizza mypizza = new Pizza.Cheff("Chicken added", "BBQ Sauce Added").build();  // to call a inner class which is static
			System.out.println(mypizza);
			
			Pizza mypizza2 = new Pizza.Cheff("Chicken added", "BBQ Sauce").setExtraCheese("Extra Cheese Added").setOlives("Olives added").build();
	...
	public Pizza(Cheff cheff) {
	 ...
	 public static class Cheff{                              // inner class - not necessary to have a inner class
		// Fixed  
		 ...
		 public Cheff(String chicken, String bbqSauce) {      // constructor for fixed values  // It has to get returned for sure
		...
		public final Cheff setExtraCheese(String extraCheese) {      // we have access this method in another class, so we return 
		...
		public Pizza build() {
			return new Pizza(this);                             // "this" returns Pizza along with Cheff
		}
	 }
}